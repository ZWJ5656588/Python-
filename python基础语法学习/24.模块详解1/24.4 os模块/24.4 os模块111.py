...
# 绝对路径
# print(os.listdir(r'C:\Users\zwj\Desktop\Coputer Science Study\Python\Pycharm文件\pythonProject 源码\python基础语法学习\24.模块详解1\24.4 os模块\24.4 os模块.py'))
#相对路径
...
# 删除文件
# os.remove(r'C:\Users\zwj\Desktop\Coputer Science Study\Python\Pycharm文件\pythonProject 源码\python基础语法学习\main.py')


# 重命名文件
os.rename('24.4 os模块.py','24.4 os模块111.py')