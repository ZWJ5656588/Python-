...
# 2.1  绝对路径读取
f=open(r"C:\Users\zwj\Desktop\Coputer Science Study\Python\Pycharm文件\pythonProject 源码\图灵学院\21.a.txt",encoding='utf-8')
f1=f.read()
print(f1)
f.close()
...
#2.3.3 文件每一行添加到列表
l=[]
_f=open(r"C:\Users\zwj\Desktop\Coputer Science Study\Python\Pycharm文件\pythonProject 源码\图灵学院\21.a.txt",encoding="utf-8")
for line in _f:
    l.append(line)
print(l)
